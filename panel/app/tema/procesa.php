...
if($confirmar){
	mensajeSpan(['bg'=>'green','text'=>(LANGUAJE['global']['data-save'][CONFIG['languaje']]),'ruta'=>"../panel.php?ap=$Apartado&tema={$post['archivo']}"]);
} else {
	mensajeSpan(['bg'=>'red','text'=>(LANGUAJE['global']['data-no-save'][CONFIG['languaje']]),'ruta'=>"../panel.php?ap=$Apartado&tema={$post['archivo']}"]);
}
