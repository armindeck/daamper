    ...
    <div class="blog">
        ...
        <section class="con-blog__header">
            <h3 class="con-blog__published">
                <?php $avatar = isset($AXR['id_publicador']) && isset($usu[$AXR['id_publicador']]['usuario']) && file_exists($Web['directorio'].Daamper::imgPath('avatar/'.$usu[$AXR['id_publicador']]['usuario'] . '.jpg')) ? 'avatar/' . $usu[$AXR['id_publicador']]['usuario'] . '.jpg' : 'avatar-profile.png'; ?>
