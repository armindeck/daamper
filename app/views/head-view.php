	...
	<!--
		Theme Name: <?= Daamper::$projectInfo->nombre ?>' Theme
		Theme URL: <?= Daamper::$projectInfo->enlace . "\n" ?>
		Author: <?= Daamper::$projectInfo->creador . "\n" ?>
		Author URL: <?= Daamper::$projectInfo->creador_enlace . "\n" ?>
		Versión: <?= Daamper::$projectInfo->version .' '.Daamper::$projectInfo->estado.' '.Daamper::$projectInfo->mod . "\n" ?>
	-->
