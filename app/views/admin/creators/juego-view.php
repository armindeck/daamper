...
<?php foreach (['os' => $lista_os, 'genre' => $lista_generos, 'engine' => $lista_motores] as $key => $lista): ?>
	<details>
		<summary><?= Language($key == 'os' ? 'operating-systems' : ($key == 'genre' ? 'genres' : 'engines')) ?? $key ?></summary>
		<section>
