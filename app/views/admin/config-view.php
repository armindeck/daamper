...
<section class="panel">
	...
	<form method="post" class="label-a" action="process/actions.php">
		...
		pSelect(['name' => 'language', 'label' => true, 'value' => (isset($_SESSION['tmp']['language']) ? $_SESSION['tmp']['language'] : Daamper::$config['language']), 'texto' => Language('language'), 'option' => Daamper::$data->Read('config/language')['global']['languages-options'][(isset($_SESSION['tmp']['language']) ? $_SESSION['tmp']['language'] : Daamper::$config['language'])]]).
