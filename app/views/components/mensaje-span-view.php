<?php if(isset($_SESSION['mensaje_span'])): ?>
	...
	<section class="div-mensaje-span mensaje-span" style="width: 99%; margin-left: auto; margin-right: auto; color: <?= $_SESSION['mensaje_span']['co']; ?>; background: <?= $_SESSION['mensaje_span']['bg']; ?>;">
